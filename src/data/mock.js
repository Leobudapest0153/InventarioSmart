...
export const shelfTemplates = [
  { id: 's-1', name: 'Anaquel Pequeño', type: 'rectangle', width: 120, height: 60, depth: 40, material: 'wood', shelves: 2 },
  { id: 's-2', name: 'Anaquel Mediano', type: 'rectangle', width: 180, height: 120, depth: 45, material: 'metal', shelves: 3 },
  { id: 's-3', name: 'Anaquel Grande', type: 'rectangle', width: 240, height: 180, depth: 60, material: 'plastic', shelves: 4 },
]
